#!/usr/bin/env python
"""Extract the 22 locus-gene features for Dataset A.

Distance (5), GTEx v10 brain cis-eQTL (10), ENCODE-rE2G (6) and one eQTL x rE2G
indicator are computed for every candidate pair.

Output: data/processed/training_matrix_dataset_a.parquet
"""
...
def audit_coverage_and_orthogonality(df: pd.DataFrame):
    ...
    log.info("Generating Multi-Omics Coverage and Orthogonality Audit Report...")
    ...
    report = f"""# Multi-Omics Coverage & Label Orthogonality Audit Report
...
---
"""
    report_path = RESULTS_DIR / "feature_coverage_summary.md"
...
def main():
    log.info("Starting Feature Extraction & Coverage Audit...")
