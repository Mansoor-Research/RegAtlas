...
def build_supplementary_tables():
    ...
    readme_tables = [
        ...
        "========================================",
        "Statistically significant Gene Ontology (GO) terms enriched among protein-coding RegAtlas Top-1",
        "prioritized schizophrenia genes (N=97) evaluated against the protein-coding candidate background",
        "(N=1,708) via g:Profiler (Benjamini-Hochberg FDR < 0.05).",
        "",
        "Column descriptions:",
