#!/usr/bin/env python
"""Build the schizophrenia application matrix (Dataset B).

Selects genome-wide significant PGC3 variants (P < 5e-8), merges lead variants
within 500 kb, maps candidate genes within +/-500 kb and attaches the same 22
features used for Dataset A.

Output: data/processed/scz_application_matrix_dataset_b.parquet
"""
...
def main():
    log.info("Starting Build SCZ Application Matrix (Dataset B)...")
    ...
    print("\n" + "="*80)
    print("SCZ APPLICATION MATRIX (DATASET B) BUILT")
    print("="*80)
