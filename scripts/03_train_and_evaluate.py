#!/usr/bin/env python
"""Train and evaluate the RegAtlas LightGBM LambdaRank model on Dataset A.

Chromosome-held-out 5-fold cross-validation with early stopping on an inner
validation split of the training loci, heuristic baselines, 7-way feature-group
ablation, 200 within-locus label permutations and feature-gain importance.

Outputs: data/processed/regatlas_oof_predictions.parquet,
...
def main():
    log.info("Starting Model Training, Baselines, and Permutation Evaluation...")
